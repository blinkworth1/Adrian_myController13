...
//The digital switch / button input pins used are, in order, 2, 14, 7, 8, 15, 22, 23, 18, 11, 5, 4, 3, 6.
...
//And there is a .txt file of wiring and what gets written out in the 3 different modes. 

//The rotary encoder is on digital 16 and 17. I use an encoder with a pushbutton (24 clicks from Adafruit).
//It has one of the pins listed above.

//For the fader, PWM speed pin is 20, and the direction pin is 21. I use an ardumoto controller from sparkfun.  
//For an HBridge use 21 as DOWNHIGH and 9 as UPHIGH
...
// This is called with the three pins (in order) that will be used to select a mode.
// After selection, the pins have their 'normal' functions (see the .txt file)
