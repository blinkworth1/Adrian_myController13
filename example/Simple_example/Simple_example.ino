...
Rotary encoder1 (0, 1); //a new encoder with left and right pins
//Rotary encoder2 (16, 17);
//Fader slider1 (A5, 4); // a new slider with an analog read pin, and "4" as the jitter-suppression setting
//Switches Buttons (15,9,10,11,14, 12); // pins for buttons ... note 8 is button 1, 9 is button 2, etc.
int encoder1mod = 0;
int encoder2mod = 0;
int pitch = 0;
